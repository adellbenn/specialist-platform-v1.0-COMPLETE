...
export class AppointmentsService {
  ...
  async complete(
    ...
    // الأخصائي المسجّل على الجلسة هو الأخصائي الفعلي للموعد، لا المعرّف الذي قد يزوّره المستدعي
    const sessionSpecialistId = appointment.specialistId ?? specialistId;
