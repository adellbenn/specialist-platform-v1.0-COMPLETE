    ...
    items: [
      {
        ...
        roles: ['super_admin', 'center_manager', 'supervisor', 'specialist', 'receptionist', 'accountant'],
      },
      {
    ...
    items: [
      {
        ...
        labelEn: 'Reports',
        icon: BarChart3,
        roles: ['super_admin', 'center_manager', 'supervisor', 'specialist', 'accountant'],
      },
      {
        ...
        labelEn: 'Analytics',
        icon: TrendingUp,
        roles: ['super_admin', 'center_manager', 'supervisor', 'accountant'],
      },
    ],
  },
  {
